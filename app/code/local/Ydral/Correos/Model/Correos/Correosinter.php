 ...
 *  ENVIO INTERNACIONAL
 */
class Ydral_Correos_Model_Correos_Correosinter extends Mage_Shipping_Model_Carrier_Abstract
{
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        */
        ...
        if (!empty($rate) && $rate['price'] >= 0) 
        {
            ...
            $method->setMethodTitle('<img src="'.Mage::getModel('core/design_package')->getSkinUrl('correos/images/logo_entregadomicilio.jpg').'" alt="" title="" /><span class="title_correos_method">&nbsp;'.$this->getConfigData('name').'</span>');
